...
const ButtonGroup = ({ className, orientation = 'horizontal', ...props }: ButtonGroupProps) => (
  <div
    className={cn(
      'inline-flex w-fit items-center rounded-lg shadow-xs **:data-[slot=button]:rounded-none [&_[data-slot=button]:first-child]:rounded-l-lg [&_[data-slot=button]:last-child]:rounded-r-lg [&_[data-slot=button]:not(:first-child)]:-ml-px',
