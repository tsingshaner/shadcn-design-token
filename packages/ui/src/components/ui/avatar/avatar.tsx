...
const Avatar = ({ className, size = 'default', ...props }: AvatarProps) => (
  <AvatarPrimitive.Root
    className={cn(
      'group/avatar relative flex shrink-0 select-none overflow-hidden rounded-full after:absolute after:inset-0 after:border after:border-border after:mix-blend-darken dark:after:mix-blend-lighten',
      size === 'sm' && 'size-6',
      size === 'default' && 'size-8',
      size === 'lg' && 'size-10',
      className
