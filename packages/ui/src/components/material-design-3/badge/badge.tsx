...
const badgeVariants = tv({
  base: 'cn-badge group/badge inline-flex min-h-4 w-fit shrink-0 items-center justify-center overflow-hidden rounded-full border px-1.5 py-0 text-[11px] font-medium leading-4 whitespace-nowrap transition-colors focus-visible:ring-3 focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 [&>svg]:pointer-events-none [&>svg]:size-3',
  defaultVariants: {
    variant: 'default'
  },
  variants: {
