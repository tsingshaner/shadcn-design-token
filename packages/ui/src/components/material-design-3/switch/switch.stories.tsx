...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A Material Design 3 binary on/off control for settings and preferences. See the [MD3 Switch specification](https://m3.material.io/components/switch/specs).'
      }
    }
  },
  tags: ['autodocs'],
  title: 'Material Design 3/Switch'
